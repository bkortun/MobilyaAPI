...
namespace Persistence.Migrations
{
    ...
    {//up veri tabanına sonradan eklenenler ya da güncellemelerdir.Down ise veri tabanından çıkarılanlardır.
    //Yeni bi migration oluşturulduğunda yapılan değişiklikler eklenir
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(//Veri tabanında tabloyu oluşturur
                name: "Categories",
                columns: table => new
                {
